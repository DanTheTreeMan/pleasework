...
class TreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tree" do
    assert_difference('Tree.count') do
      post trees_url, params: { tree: { description: @tree.description, height: @tree.height, image_url: @tree.image_url, name: @tree.name, price: @tree.price, width: @tree.width } }
    end
  ...
  test "should update tree" do
    patch tree_url(@tree), params: { tree: { description: @tree.description, height: @tree.height, image_url: @tree.image_url, name: @tree.name, price: @tree.price, width: @tree.width } }
